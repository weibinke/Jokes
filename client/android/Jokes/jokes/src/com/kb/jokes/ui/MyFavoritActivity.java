...
public class MyFavoritActivity extends FragmentActivity{
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		getSupportFragmentManager().beginTransaction().replace(R.id.myfavoirte_fragment, new MyFavoriteView()).commit();
	...
	private void initView(){
		...
		title.setText(R.string.homepage_myfavorite);
